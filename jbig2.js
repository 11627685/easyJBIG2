...
function decodeRefinement(
  ...
  for (let i = 0; i < height; i++) {
    if (prediction) {
      ...
      ltp ^= sltp;
      if (ltp) {
        console.log("prediction is not supported");
...
function decodeSymbolDictionary(
  ...
  if (huffman && refinement) {
    console.log("symbol refinement with Huffman is not supported");
  }
...
function decodeTextRegion(
  ...
  if (huffman && refinement) {
    console.log("refinement with Huffman is not supported");
  }
...
function decodeHalftoneRegion(
  ...
  const skip = null;
  if (enableSkip) {
    console.log("skip is not supported");
  }
...
function readSegmentHeader(data, start) {
  ...
  if (!SegmentTypes[segmentType]) {
    console.log("invalid segment type: " + segmentType);
  }
  ...
  if (referredFlags === 7) {
    ...
    console.log("invalid referred-to flags");
  }
  ...
  if (segmentHeader.length === 0xffffffff) {
    ...
    if (segmentType === 38) {
      ...
      if (segmentHeader.length === 0xffffffff) {
        console.log("segment end was not found");
      }
    } else {
      console.log("invalid unknown segment length");
    }
  }
...
function parseJbig2(data) {
  ...
  if (
    ...
    console.log("parseJbig2 - invalid header.");
  }
...
class HuffmanTreeNode {
  ...
  decodeNode(reader) {
    ...
    if (!node) {
      console.log("invalid Huffman data");
    }
...
function getStandardTable(number) {
  ...
  switch (number) {
    ...
    case 15:
      ...
      break;
    default:
      console.log(`standard table B.${number} does not exist`);
  }
  ...
  readBit() {
    if (this.shift < 0) {
      if (this.position >= this.end) {
        console.log("end of data while reading bit");
      }
...
function getCustomHuffmanTable(index, referredTo, customTables) {
  ...
  console.log("can't find custom Huffman table");
}
...
function getTextRegionHuffmanTables(
  ...
  for (let i = 0; i < numberOfSymbols;) {
    ...
    if (codeLength >= 32) {
      ...
      switch (codeLength) {
        case 32:
          if (i === 0) {
            console.log("no previous value in symbol ID table");
          }
        ...
        case 34:
          ...
          break;
        default:
          console.log("invalid code length in symbol ID table");
      }
  ...
  switch (textRegion.huffmanFS) {
    ...
    case 3:
      ...
      break;
    default:
      console.log("invalid Huffman FS selector");
  }
  ...
  switch (textRegion.huffmanDS) {
    ...
    case 3:
      ...
      break;
    default:
      console.log("invalid Huffman DS selector");
  }
  ...
  switch (textRegion.huffmanDT) {
    ...
    case 3:
      ...
      break;
    default:
      console.log("invalid Huffman DT selector");
  }
...
function getSymbolDictionaryHuffmanTables(
  ...
  switch (dictionary.huffmanDHSelector) {
    ...
    case 3:
      ...
      break;
    default:
      console.log("invalid Huffman DH selector");
  }
  ...
  switch (dictionary.huffmanDWSelector) {
    ...
    case 3:
      ...
      break;
    default:
      console.log("invalid Huffman DW selector");
  }
